        ...
        <div class="account-right">
            <div class="w-100">
                <div class="section-title text-center">
                    ...
                    <h4 class="title mt-3 mb-0">@langg('User Login')</h4>
                </div>
                <form class="row g-4" action="{{route('user.login')}}" method="post" onsubmit="return recaptcha();">
                    ...
                    <div class="col-sm-12 form-group">
                        <label class="form--label" for="password">@langg('Password')</label>
                    ...
                    <div class="col-sm-12 form-group">
                        <div class="d-flex flex-wrap justify-content-between">
                            <div>
                                <a href="{{route('user.register')}}">@langg('Don\'t have any Account ?')</a>
                            </div>
                            <div>
                    ...
                    <div class="col-xl-12 form-group">
                        <button type="submit" class="cmn--btn">@langg('Login')</button>
                    </div>
                </form>
            </div>
        </div>
