                            ...
                            <div class="blog__item">
                                <div class="blog__item-img">
                                    <a href="{{route('blog.details',[$item->id,$item->slug])}}">
                                        <img class="w-50" src="{{getPhoto($item->photo)}}" alt="blog">
                                    </a>
                                </div>
                                <div class="blog__item-content">
                                    ...
                                    <h5 class="blog__item-content-title">
                                        <a href="{{route('blog.details',[$item->id,$item->slug])}}">
                                           {{translate(Str::limit($item->title,30))}}
                                        </a>
                                    </h5>
                                    <a href="{{route('blog.details',[$item->id,$item->slug])}}" class="read-more">@langg('Read More')</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
