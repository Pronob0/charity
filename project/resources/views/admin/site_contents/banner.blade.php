                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-12">
                                ...
                                <div class="custom-file">
                                    ...
                                    <code class="text-danger">@langg('Image size : 1320p x 880 px')</code>
                           ...
                           @endif
                            ...
                            <div class="form-group col-md-6">
                                <label for="">@langg('Button 1 Name')</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="">@langg('Button 1 URL')</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="">@langg('Button 2 Name')</label>
                                <input type="text" name="button_2_name" class="form-control" placeholder="@langg('Button Name')" value="{{@$section->content->button_2_name}}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">@langg('Button 2 URL')</label>
                                <input type="text" name="button_2_url" class="form-control" placeholder="@langg('Button URL')" value="{{@$section->content->button_2_url}}" required>
                            </div>
                            <div class="col-md-12">
