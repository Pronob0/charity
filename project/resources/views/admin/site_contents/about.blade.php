                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-12">
                                ...
                                <div class="custom-file">
                                    ...
                                    <code class="text-danger">@langg('Image size : 700 x 570 px')</code>
                           ...
                           @endif
                            ...
                            <div class="form-group col-md-6">
                                <label for="">@langg('Feature 1 Icon')</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="">@langg('Feature 1 Title')</label>
                                <input type="text" name="feature_1_title" class="form-control" placeholder="@langg('Feature Title')" value="{{@$section->content->feature_1_title}}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">@langg('Feature 1 Details')</label>
                                <input type="text" name="feature_1_details" class="form-control" placeholder="@langg('Feature Details')" value="{{@$section->content->feature_1_details}}" required>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="">@langg('Feature 2 Icon')</label>
                                <div class="input-group">
                            ...
                            <div class="form-group col-md-6">
                                <label for="">@langg('Feature 2 Title')</label>
                                <input type="text" name="feature_2_title" class="form-control" placeholder="@langg('Feature Title')" value="{{@$section->content->feature_2_title}}" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">@langg('Feature 2 Details')</label>
                                <input type="text" name="feature_2_details" class="form-control" placeholder="@langg('Feature Details')" value="{{@$section->content->feature_2_details}}" required>
                            </div>
