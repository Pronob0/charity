                    ...
                    <table class="table table-striped">
                        ...
                        @forelse ($deposits as $info)
                            <tr>
                                 ...
                                 <td data-label="@langg('Amount')">{{amount($info->amount,$info->currency->type,2)}} {{$info->currency->code}}</td>
                                 <td data-label="@langg('Charge')">{{amount($info->charge,$info->currency->type,2)}} {{$info->currency->code}}</td>
