            ...
            <div class="card">
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between">@langg('Total Deposited') <span>{{$data['totalDeposit']}} {{$gs->curr_code}}</span></li>
                        <li class="list-group-item d-flex justify-content-between">@langg('Total Withdraw') <span>{{$data['totalWithdraw']}} {{$gs->curr_code}}</span></li>
