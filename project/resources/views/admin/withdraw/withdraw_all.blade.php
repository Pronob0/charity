                                ...
                                <tr>
                                    ...
                                    <td data-label="@langg('Action')">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center justify-content-end justify-content-lg-center">
                                            <button class="btn btn-info details m-1" data-user_data="{{$withdrawlog->user_data}}" data-transaction="{{$withdrawlog->trx}}" data-provider="{{$withdrawlog->user ? $withdrawlog->user->email : $withdrawlog->merchant->email}}" data-method_name="{{$withdrawlog->method->name}}" data-date="{{ __($withdrawlog->created_at->format('d F Y')) }}">@langg('Details')</button>
            ...
            $('.details').on('click',function(){
                ...
                let html = `
                    ...
                    <ul class="list-group">
                        ...
                        <hr>
                        <h6>@langg('User Data For Withdraw : ')</h6>
